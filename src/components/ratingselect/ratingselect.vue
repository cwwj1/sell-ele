<template>
  <div class="ratingselect">
    <div class="rating-type">
      <span @click="select(2,$event)" class="block positive" :class="{'positive-active': selectType === 2}">
        {{desc.all}}
    ...
    <div @click="toggleContent" class="switch" :class="{'switch_on': onlyContent}">
...
<style>
  ...
  .ratingselect .switch .icon-check{
    display: inline-block;
    vertical-align: top;
    width: 24px;
    height: 24px;
    margin-right: 4px;
    background: url("chenck.png") center no-repeat;
    background-size: 24px 24px;
  }
  .ratingselect .switch_on .icon-check{
    display: inline-block;
    vertical-align: top;
    width: 24px;
    height: 24px;
    margin-right: 4px;
    background: url("chenck_on.png") center no-repeat;
    background-size: 24px 24px;
  }
